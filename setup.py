...
os.system("wget https://github.com/mozilla/geckodriver/releases/download/v0.13.0/geckodriver-v0.13.0-linux64.tar.gz")
os.system("tar -xvzf geckodriver-v0.13.0-linux64.tar.gz")
os.system("rm geckodriver-v0.13.0-linux64.tar.gz")
